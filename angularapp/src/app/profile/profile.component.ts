...
export class ProfileComponent implements OnInit {
  ...
  fetchCustomerData() {
    this.http.get(`https://8080-bfbfcfbdddeffacdcbbcecdcebafeccfa.project.examly.io/register/${this.customerId}`).subscribe(
      (data) => {
        this.customer = data;
      },
      (error) => {
  ...
  updateCustomer() {
    ...
    this.http.put(`https://8080-bfbfcfbdddeffacdcbbcecdcebafeccfa.project.examly.io/register/${this.customer.customerId}`, updatedCustomer).subscribe(
      (data) => {
        this.customer = data;
